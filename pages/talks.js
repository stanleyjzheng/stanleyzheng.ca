...
function Talks(props) {
  const renderFeatured = () => {
    const featured = ['PyData Boston-Cambridge', 'IEEE Conference on Advanced Technologies for Communications']
  ...
  const description = `I attended first hackathon in 2020 and fell in love with the community and <strong>sharing knowledge</strong> publicly.`
  ...
  return (
    <>
      <Head>
        ...
        <meta content="https://stanleyzheng.ca/talks" property="og:url" />
